...
const config = {
  title: 'Echols Home',
  tagline: 'Living for the glory of God.',
  ...
  organizationName: 'echo-core', // Usually your GitHub org/user name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/echo-core/docs-site/tree/main/site/',
        },
        blog: {
  ...
  themeConfig:
	...
	/**
	  ...
	  **/
          {to: '/heaven', label: 'Heaven', position: 'left'},
          {
            href: 'https://github.com/echo-core/docs-site',
            label: 'GitHub',
            position: 'right',
          },
        ],
	...
	/**
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Echols Home.`,
      },
      prism: {
